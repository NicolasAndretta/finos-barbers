...
## Carrusel · Cómo reserva un cliente (6 placas)

- **Archivos:** `social/posts/carrusel-turnos/` (en orden: carrusel-turnos-1.png, carrusel-turnos-2.png, carrusel-turnos-3.png, carrusel-turnos-4.png, carrusel-turnos-5.png, carrusel-turnos-6.png)
- **Formato:** Carrusel 1080×1350 (4:5)
